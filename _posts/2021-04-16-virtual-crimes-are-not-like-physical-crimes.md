...
I'm not saying that the owner of an insecure IT-system is "guilty".  Clearly, from a juridical point of view, the attacker is doing a crime, and the owner of the attacked systems is innocent.  This is not a juridical or moral thing, this is a purely practical thing - blaming the offender doesn't work.  For a "clean" cyber attach, it is almost never possible to catch the criminal, it's impossible to elimiate bad actors on the Internet, but it'ss very possible to work on improved computer security.
